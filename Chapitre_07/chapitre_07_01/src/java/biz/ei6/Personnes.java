...
public class Personnes {
    static List<Personne> lesPersonnes;
    
    static {
        lesPersonnes = new ArrayList<>();
        
        lesPersonnes.add(new Personne("Fabien","Brissonneau"));
        lesPersonnes.add(new Personne("Corinne","Bazin"));
    }
    ...
    public void ajouteUnePersonne(@FormParam("prenom")String prenom, @FormParam("nom")String nom) {
        ...
        System.out.println("Post personne "+prenom+" , "+nom);
    }
}
